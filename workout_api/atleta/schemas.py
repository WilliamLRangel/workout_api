...
class Atleta(BaseSchema):
    nome: Annotated[str, Field(description='Nome do atleta', example='Geraldo', max_length=50)]
    nome: Annotated[str, Field(description='Nome do atleta', example='João', max_length=50)]
    cpf: Annotated[str, Field(description='CPF do atleta', example='098765432100', max_length=11)]
...
class AtletaUpdate(BaseSchema):
    ...
    nome: Annotated[Optional[str], Field(None, description='Nome do atleta', example='Alessandro', max_length=50)]
